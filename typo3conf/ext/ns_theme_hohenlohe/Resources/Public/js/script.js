...
$(document).ready(function () {
    ...
    $('.navigation > nav > ul > li.has-sub > a').click(function () {
        ...
        if (win_width() > 767) {
            ...
            // $('.second-level-menu li.has-sub')
        }
    });
    $(".second-level-menu > ul > li.has-sub > a").click(function (e) {
        e.preventDefault();
        ...
        if ( win_width() < 767) {
            $(this).parents('body').addClass('body-effect');
        }
    ...
    $('.second-level-link.back-link').click(function () {
        ...
        $(this).parents('body').removeClass('body-effect');
    });

...
return [
    'packages' => [
        ...
        'ns_basetheme' => [
            'packagePath' => 'typo3conf/ext/ns_basetheme/',
        ],
        'ns_theme_hohenlohe' => [
            'packagePath' => 'typo3conf/ext/ns_theme_hohenlohe/',
        ],
        'blog' => [
            'packagePath' => 'typo3conf/ext/blog/',
        ],
        'cloudflare' => [
            'packagePath' => 'typo3conf/ext/cloudflare/',
        ],
        'container' => [
            'packagePath' => 'typo3conf/ext/container/',
        ],
        'faf_companies' => [
            'packagePath' => 'typo3conf/ext/faf_companies/',
        ],
        'news' => [
            'packagePath' => 'typo3conf/ext/news/',
        ],
        'ns_cookiebot' => [
            'packagePath' => 'typo3conf/ext/ns_cookiebot/',
        ],
        'staticfilecache' => [
